  ...
  return (
    <div className='frontend-article-detail'>
      ...
      <div className="section">
        <div className="banner-content" style={{backgroundImage: `url(${store.selectedArticle?.path_image ? process.env.REACT_APP_BASE_URL + store.selectedArticle?.path_image : BgArticle})`}}>
