...
import BgResearch from '@src/assets/frontend/img/banner/banlit.jpg'
  ...
  return (
    <div className="frontend-research">
      ...
      <div className="section">
        <div className="banner-bg" style={{backgroundImage: `url("${BgResearch}")`, minHeight: '330px', position: 'relative', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: '100% 100%'}}>
