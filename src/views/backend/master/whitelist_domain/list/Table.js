...
// ** Store & Actions
import { getDataWhitelistDomain, getWhitelistDomain } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          <Link to='/master/whitelist_domain/save' onClick={handleCreate}>
...
const DepartemenList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataWhitelistDomain(store.params)
      )
  ...
  const handleCreate = e => {
    dispatch(getWhitelistDomain(null))
  }
