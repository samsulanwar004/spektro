...
// ** Store & Actions
import { getDataCertificate, getCertificate } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          <Link to='/course/certificate/save' onClick={handleCreate}>
...
const DepartemenList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataCertificate(store.params)
      )
    }
  }, [dispatch])
