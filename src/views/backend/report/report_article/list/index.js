...
// ** Store & Actions
import { getReportArticle } from '../store/action'
                ...
                {store.allData.map((data, key) => {
                  ...
                  return (
                    <tr key={key}>
                      ...
                      <td className='text-nowrap'>{data.company}</td>
                      ...
                      <td className='text-nowrap'>{removeTags(data.description)}</td>
