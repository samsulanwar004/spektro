...
// ** Store & Actions
import { getDataPeserta, getPeserta } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          <Link to='/kmbi/peserta/save' onClick={handleCreate}>
...
const UsersList = () => {
  ...
  const store = useSelector(state => state.pesertas)
