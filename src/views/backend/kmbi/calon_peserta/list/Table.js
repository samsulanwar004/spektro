...
// ** Store & Actions
import { getDataCalonPeserta, getCalonPeserta } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          <Link to='/kmbi/calon_peserta/save' onClick={handleCreate}>
...
const UsersList = () => {
  ...
  useEffect(() => {
    if (!store.params) {
      ...
      dispatch(
        getDataCalonPeserta(store.params)
      )
