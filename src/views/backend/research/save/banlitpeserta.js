...
const BanlitSave = () => {
  ...
  useEffect(() => {
    ...
    if (store.selected !== null && store.selected !== undefined) {
      dispatch(getPesertaResearchData({
  ...
  const onSubmit = data => {
    ...
    if (isObjEmpty(errors)) {
      ...
      datas.append('status_id', id ? selectedStatus.value : 'NN')
      ...
      dispatch(addPesertaResearch(datas))
    }
  }
